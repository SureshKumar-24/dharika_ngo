...
export const FoodDrivesSection: React.FC<FoodDrivesSectionProps> = ({
  title,
  description,
  images,
  statistics,
  ...
  return (
    <>
      ...
      <Section id="food-drives" className="bg-pastel-pink py-16 md:py-24">
        <Container>
          <motion.div
            ref={ref}
...
FoodDrivesSection.displayName = 'FoodDrivesSection';
